...
import com.aki.anichan.helper.enums.getAniListMediaSort
import com.aki.anichan.helper.enums.getAniListReviewSort
...
class DefaultContentDataSource(private val apolloHandler: ApolloHandler, private val statusVersion: Int, private val sourceVersion: Int) : ContentDataSource {
    ...
    override fun getHomeQuery(): Observable<ApolloResponse<HomeDataQuery.Data>> {
        val query = HomeDataQuery(
            ...
            season = Optional.present(com.aki.anichan.helper.utils.TimeUtil.getCurrentSeason()),
            seasonYear = Optional.present(com.aki.anichan.helper.utils.TimeUtil.getCurrentYear()),
            nextSeason = Optional.present(com.aki.anichan.helper.utils.TimeUtil.getNextSeason()),
            nextYear = Optional.present(com.aki.anichan.helper.utils.TimeUtil.getNextSeasonYear())
        )
