...
import com.aki.anichan.data.response.animethemes.AnimePaginationResponse
import com.aki.anichan.data.response.mal.AnimeResponse

fun AnimePaginationResponse.convert(): Anime {
    val anime = anime?.firstOrNull() ?: com.aki.anichan.data.response.animethemes.AnimeResponse()
    return Anime(
        id = anime.id ?: 0,
        name = anime.name ?: "",
        slug = anime.slug ?: "",
