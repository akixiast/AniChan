...
import com.aki.anichan.helper.pojo.MediaFilterComponent
    ...
    fun loadMediaFilterComponent() {
        _mediaFilterComponent.onNext(
            MediaFilterComponent(
                mediaFilter,
                when (currentSearchCategory) {
                    SearchCategory.ANIME -> com.aki.anichan.helper.enums.MediaType.ANIME
                    SearchCategory.MANGA -> com.aki.anichan.helper.enums.MediaType.MANGA
                    else -> com.aki.anichan.helper.enums.MediaType.ANIME
                },
