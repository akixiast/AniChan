...
import com.aki.anichan.data.network.apollo.adapter.JsonAdapter
import com.aki.anichan.data.response.anilist.MediaList
import com.aki.anichan.databinding.DialogBottomSheetMediaListQuickDetailBinding
...
import com.aki.anichan.ui.editor.AdvancedScoringRvAdapter
import com.aki.anichan.ui.editor.CustomListsRvAdapter
        ...
        disposables.addAll(
            viewModel.settings.subscribe { (mediaListOptions, appSetting) ->
                ...
                with(binding) {
                    ...
                    dialogMediaListStatus.text = mediaList.status?.getString(media.type?.getMediaType() ?: com.aki.anichan.helper.enums.MediaType.ANIME)
