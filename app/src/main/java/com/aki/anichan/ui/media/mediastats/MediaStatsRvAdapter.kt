...
import com.aki.anichan.helper.pojo.Chart
import com.aki.anichan.helper.pojo.MediaStatsItem
...
class MediaStatsRvAdapter(
    ...
    inner class StatusDistributionViewHolder(private val binding: LayoutMediaStatusDistributionBinding) : ViewHolder(binding) {
        ...
        private fun getStatusLabel(status: MediaListStatus?, mediaType: MediaType?): String {
            return status?.getString(if (mediaType == MediaType.MANGA) com.aki.anichan.helper.enums.MediaType.MANGA else com.aki.anichan.helper.enums.MediaType.ANIME) ?: ""
        }
    }
