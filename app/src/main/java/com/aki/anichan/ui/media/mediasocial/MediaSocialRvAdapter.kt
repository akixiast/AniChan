...
import com.aki.anichan.databinding.ListActivityMediaBinding
import com.aki.anichan.databinding.ListFollowingMediaListBinding
...
import com.aki.anichan.helper.pojo.MediaSocialItem
    ...
    inner class FollowingMediaListViewHolder(private val binding: ListFollowingMediaListBinding) : ViewHolder(binding) {
        override fun bind(item: MediaSocialItem?, index: Int) {
            ...
            with(binding) {
                ...
                val mediaType = if (item.mediaList.media.type == com.aki.anichan.type.MediaType.MANGA) MediaType.MANGA else MediaType.ANIME
