package com.aki.anichan.ui.search
...
import com.aki.anichan.databinding.ListSearchBinding
import com.aki.anichan.helper.enums.SearchCategory
import com.aki.anichan.helper.extensions.*
import com.aki.anichan.helper.pojo.SearchItem
            ...
            binding.apply {
                when (item.searchCategory) {
                    SearchCategory.ANIME, SearchCategory.MANGA -> {
                        ...
                        searchMediaListStatusText.text = item.media.mediaListEntry?.status?.getString(item.media.type?.getMediaType() ?: com.aki.anichan.helper.enums.MediaType.ANIME)?.uppercase()
                        ...
                        searchMediaLengthText.text = when (item.media.type?.getMediaType()) {
                            com.aki.anichan.helper.enums.MediaType.ANIME -> item.media.getLength()?.showUnit(context, R.plurals.episode)
                            com.aki.anichan.helper.enums.MediaType.MANGA -> item.media.getLength()?.showUnit(context, R.plurals.chapter)
                            else -> ""
                        }
