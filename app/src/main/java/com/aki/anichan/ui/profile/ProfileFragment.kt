...
import com.aki.anichan.databinding.FragmentProfileBinding
...
class ProfileFragment : BaseFragment<FragmentProfileBinding, ProfileViewModel>() {
    ...
    override fun setUpLayout() {
        binding.apply {
            ...
            profileAnimeCountLayout.clicks {
                if (isViewer())
                    sharedViewModel.navigateTo(SharedMainViewModel.Page.LIBRARY)
                else {
                    doIfUserIdIsLoaded {
    ...
    override fun setUpInsets() {
        ...
        binding.profileToolbar.applyTopPaddingInsets()
        if (!isViewer()) {
