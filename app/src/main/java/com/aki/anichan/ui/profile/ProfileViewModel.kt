...
import com.aki.anichan.data.response.anilist.UserStatistics
...
import com.aki.anichan.helper.extensions.formatTwoDecimal
import com.aki.anichan.helper.extensions.getStringResource
import com.aki.anichan.helper.pojo.Affinity
import com.aki.anichan.helper.pojo.ProfileItem
import com.aki.anichan.helper.pojo.Tendency
            ...
            disposables.add(
                userRepository.getIsAuthenticated().zipWith(userRepository.getAppSetting()) { isAuthenticated, appSetting ->
                    ...
                    .subscribe { (isAuthenticated, appSetting) ->
                        ...
                        // guest viewing own (empty) profile: layout already shows
                        // not-logged-in, skip the viewer query that needs auth
                        if (userId != null || name != null || isAuthenticated) {
                            loadUserData()
                        } else {
